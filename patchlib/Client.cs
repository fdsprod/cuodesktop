...
{	
	public sealed class Client
    {
		...
		public const string ThreeDClient = "Ultima Online Third Dawn";
		public const string TwoDClient = "Ultima Online";
		public const string NotFound = "Not Found";

        public static string DetectInstallFolder()
        {
            string path = Path.GetDirectoryName(DetectClient(TwoDClient));

            if (path == "Not Found")
                path = Path.GetDirectoryName(DetectClient(ThreeDClient));
